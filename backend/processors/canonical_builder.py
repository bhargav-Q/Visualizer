# ==============================================================================
# CANONICAL IR BUILDER (DEPRECATED & COMMENTED OUT FOR MISTRAL OCR)
...
class CanonicalIRBuilder:
    """Lightweight stub preserving import safety while Canonical IR is bypassed."""
    @staticmethod
    def build_ir(*args, **kwargs):
        return None
